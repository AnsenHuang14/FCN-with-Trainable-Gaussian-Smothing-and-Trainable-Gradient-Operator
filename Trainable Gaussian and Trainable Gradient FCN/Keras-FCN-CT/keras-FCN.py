...
if __name__ == '__main__':
	...
	parser.add_argument("-input_shape",default='512',type=int,help="Input image width and height")
	...
	if args.calculate_hist:
		hist_list_train = hist_list[0:150]
		hist_list_val = hist_list[150:180]
		hist_list_test = hist_list[180:]
	else: 
	...
	if args.evaluate:
		...
		original_X_train = original_X[0:150]
		original_X_val = original_X[150:180]
		original_X_test = original_X[180:]
